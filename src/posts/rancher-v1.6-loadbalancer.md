...
![](/assets/media/rancher-v1.6-loadbalancer/config.jpg)
...
#### 关于Capture
1. `IPCountry` 需要自己设定在 Cloudflare 设置 `Page Rule`，不过呢，Logstash 本身也有这个功能：![](/assets/media/rancher-v1.6-loadbalancer/logstash.jpg)
...
![](/assets/media/rancher-v1.6-loadbalancer/result_1.jpg)
![](/assets/media/rancher-v1.6-loadbalancer/result_2.jpg)
...
![](/assets/media/rancher-v1.6-loadbalancer/haproxy.jpg)

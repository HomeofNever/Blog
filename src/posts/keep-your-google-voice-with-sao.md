...
![](/assets/media/keep-your-google-voice-with-sao/cloudflare_abuse.png)

不过反正 Google Voice 互相发送不要钱, 为什么不随便找个人发呢?

![](/assets/media/keep-your-google-voice-with-sao/chat_1.png)
...
Tasker 是我当时为了挂国内短信卡而购入的一款自动化软件, 详细历史可以看这一篇[华为短信机](/posts/tasker-messenger/)

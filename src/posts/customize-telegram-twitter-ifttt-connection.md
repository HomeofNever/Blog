...
![](/assets/media/customize-telegram-twitter-ifttt-connection/twitter.png)
...
![](/assets/media/customize-telegram-twitter-ifttt-connection/telegram.png)
...
![](/assets/media/customize-telegram-twitter-ifttt-connection/ifttt.png)
...
![](/assets/media/customize-telegram-twitter-ifttt-connection/telegram_old_result.png)

于是每次我还要手动发布推文后等同步手动修正空格问题, 删除或者替换多余跳转链接, 有点恼火

直到 [@anankke](https://blog.anank.ke) 提醒了我`webhook`的存在

![](/assets/media/customize-telegram-twitter-ifttt-connection/chat.png)
...
![](/assets/media/customize-telegram-twitter-ifttt-connection/ifttt_new.png)
...
![](/assets/media/customize-telegram-twitter-ifttt-connection/telegram_final.png)
